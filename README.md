# My-Own-Shell.
## Why make your own shell?
### Still in the making. We'll see later


## What is a Shell?
### Ok, so in simple terms its the interface from which we comunate to the operating system (OS). Be it by using comands, files, etc. The purpose of it, is to translate our needs to the Kernel. 
